...
/* Scroll to top — فوق الواتساب، تصميم عصري */
.fab--top {
  bottom: 90px;
  left: 30px;
...
.fab-fade-enter-active, .fab-fade-leave-active { transition: all 0.3s cubic-bezier(0.4,0,0.2,1); }
.fab-fade-enter-from, .fab-fade-leave-to { opacity: 0; transform: translateY(10px) scale(0.9); }
